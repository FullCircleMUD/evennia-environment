...
[../CLAUDE.md](../CLAUDE.md) § Load-bearing architectural principles, and the open questions are in
[test-plan.md](test-plan.md) § Open decisions. A `design.md` lands when there is more to say than
that.
